...
class ApplicantsControllerTest < ActionController::TestCase
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post :create, applicant: { application_case_id: @applicant.application_case_id, contact_id: @applicant.contact_id }
    end
  ...
  test "should update applicant" do
    patch :update, id: @applicant, applicant: { application_case_id: @applicant.application_case_id, contact_id: @applicant.contact_id }
    assert_redirected_to applicant_path(assigns(:applicant))
  end
